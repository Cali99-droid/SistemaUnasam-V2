...
function validarPermisos($permiso)
{
    ...
    //rutas como permisos
    $libre = ['/inicio', '/perfil', '/reporte', '/', '/logout', '/olvide', '/recuperar', '/desercion', '/desercion-eliminar', '/docs/noExiste', '/login', '/organizacion'];

    $permisosGrupo = ['/grupos', '/grupo', '/grupo/eliminar', '/api/grupos', '/integrante/getParticipaciones',  '/integrante', '/integrante/setAsistencia', '/integrante/deleteAsistencia', '/integrante/setBeneficio',   '/integrante/getBeneficio', '/integrante/updBeneficioEst', '/integrante/eliminar-beneficio', '/api/getIntegrante', '/api/setTntegrante', '/rendimiento', '/rendimiento/eliminar', '/integrante-eliminar', '/desercionAlumno', '/integrante/crearIntegrante'];
