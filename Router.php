...
class Router
{
    ...
    public function comprobarRutas()
    {
        ...
        $rutas_protegidas = ['/inicio', '/perfil', '/grupos', '/grupo', '/grupo/eliminar', '/api/grupos', '/integrante/getParticipaciones', '/integrante/crearIntegrante', '/integrante', '/integrante/setAsistencia', '/integrante/deleteAsistencia', '/integrante/setBeneficio',   '/integrante/getBeneficio', '/integrante/updBeneficioEst', '/rendimiento', '/rendimiento/eliminar', '/api/getIntegrante', '/api/setTntegrante', '/integrante-eliminar', '/integrante/eliminar-beneficio',  '/beneficios', '/beneficios/getBeneficio', '/beneficios', '/beneficios/asignar', '/beneficios/crear', '/beneficiosTipo', '/tipoBeneficios/eliminar', '/beneficios-eliminar',  '/eventos', '/eventos', '/nuevo-evento', '/actualizar-evento', '/crear-evento', '/crear-org', '/eventos-eliminar', '/eventos/invitar-grupo', '/evento/orgs', '/evento-invitacion', '/invitacion-eliminar', '/reporte', '/tipos', '/api/tipos-eliminar', '/usuarios', 'admin/usuarios', '/roles', '/crear-rol', '/semestres-eliminar', '/get-rol',  '/crear-user', '/get-user', '/usuarios-eliminar', '/semestres', '/api/tipos', '/api/alumno', '/api/crearAlumno', '/docs/noExiste', '/desercion-eliminar', '/desercionAlumno'];
